...
- 2020.1 T2-2253站点正式开发（12类）：使用改进的yolo_v3进行缺陷检测；使用ResNet进行缺陷分类。
  ...
  - 做过的事情：
    ...
    - 训练脚本输出的Log文本的解析：Log文本比较杂，主要运用matplotlib.pyplot实现[analysis_log.py]。
      ...
      ![加载图片失败](https://github.com/ischansgithub/MyProjectExperience/blob/master/%E9%A1%B9%E7%9B%AE%E7%BB%8F%E5%8E%86%E8%B5%84%E6%96%99/image/image-20200326210959555.png)
